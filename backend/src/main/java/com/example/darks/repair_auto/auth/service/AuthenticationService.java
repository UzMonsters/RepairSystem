...
import com.example.darks.repair_auto.security.JwtTokenService;
...
public class AuthenticationService {
    ...
    public LoginResponse login(String email, String password, String ip, String userAgent) {
        ...
        User user = userRepository.findByEmail(normalizedEmail)
                .filter(candidate -> passwordService.matches(password, candidate.getPasswordHash()))
    ...
    private BusinessRuleException invalidCredentials(String normalizedEmail) {
        LOGGER.info("Authentication event operation=login result=failure reason=INVALID_CREDENTIALS email={}",
                normalizedEmail);
