...
public class TelegramMessages {
    ...
    public TelegramMessages() {
        messages.put(LanguageCode.EN, Map.ofEntries(
                ...
                entry("share_contact_button", "Share phone number"),
                ...
                entry("field.priority", "Priority"),
                entry("field.location", "Location"),
                entry("field.created", "Created"),
                entry("field.photos", "Photos"),
                entry("field.language", "Language"),
                ...
                entry("photo_received", "Photo %d/%d received. Send another photo, or skip."),
                entry("photo_received_max", "Photo %d/%d received."),
                entry("photo_duplicate", "This photo is already attached (%d/%d). Send another photo, or skip."),
                entry("max_photos_reached", "Maximum of %d photos reached."),
                entry("photo_invalid", "Invalid photo. Please send a valid image."),
                entry("photo_download_failed", "Could not process the photo. Please try again."),
                entry("location_prompt", "Share your location, enter an address, or skip."),
                entry("request.location.title", "Share your location, enter an address, or skip."),
                entry("request.location.send_current", "📍 Send current location"),
                entry("request.location.enter_address", "⌨️ Enter address"),
                entry("request.location.skip", "⏭ Skip"),
                entry("request.location.invalid", "Please send your location, enter an address, or skip this step."),
                entry("request.location.address_prompt", "Please enter your address:"),
                entry("request.location.received", "Location received."),
                entry("request.location.not_provided", "Not provided"),
                entry("request.location.confirmation", "Location: %s"),
                entry("confirm_prompt", "Confirm request"),
                entry("request_created", "Request created."),
                ...
                entry("review_confirmation", "Category: %s\nRating: %d/5\nComment: %s"),
                ...
                entry("telegram.request.priority.LOW", "Low"),
                entry("telegram.request.priority.NORMAL", "Normal"),
                entry("telegram.request.priority.HIGH", "High"),
                entry("telegram.request.priority.URGENT", "Urgent"),
                entry("back", "Back"),
        ...
        messages.put(LanguageCode.RU, Map.ofEntries(
                ...
                entry("share_contact_button", "Поделиться телефоном"),
                ...
                entry("field.priority", "Приоритет"),
                entry("field.location", "Местоположение"),
                entry("field.created", "Создано"),
                entry("field.photos", "Фото"),
                entry("field.language", "Язык"),
                entry("field.name", "Имя"),
                entry("field.phone", "Телефон"),
                ...
                entry("photo_received", "Фото %d/%d получено. Отправьте еще фото или пропустите."),
                entry("photo_received_max", "Фото %d/%d получено."),
                entry("photo_duplicate", "Это фото уже прикреплено (%d/%d). Отправьте другое фото или пропустите."),
                entry("max_photos_reached", "Максимально принимается %d фото."),
                entry("photo_invalid", "Неверный формат фото. Отправьте изображение."),
                entry("photo_download_failed", "Не удалось обработать фото. Попробуйте еще раз."),
                entry("location_prompt", "Отправьте геолокацию, введите адрес или пропустите."),
                entry("request.location.title", "Отправьте геолокацию, введите адрес или пропустите."),
                entry("request.location.send_current", "📍 Отправить локацию"),
                entry("request.location.enter_address", "⌨️ Ввести адрес"),
                entry("request.location.skip", "⏭ Пропустить"),
                entry("request.location.invalid", "Пожалуйста, отправьте геолокацию, введите адрес или пропустите этот шаг."),
                entry("request.location.address_prompt", "Пожалуйста, введите адрес:"),
                entry("request.location.received", "Геолокация получена."),
                entry("request.location.not_provided", "Не указано"),
                entry("request.location.confirmation", "Местоположение: %s"),
                entry("confirm_prompt", "Подтвердите заявку"),
                entry("request_created", "Заявка создана."),
                ...
                entry("review_confirmation", "Категория: %s\nОценка: %d/5\nКомментарий: %s"),
                ...
                entry("telegram.request.priority.LOW", "Низкий"),
                entry("telegram.request.priority.NORMAL", "Обычный"),
                entry("telegram.request.priority.HIGH", "Высокий"),
                entry("telegram.request.priority.URGENT", "Срочный"),
                entry("back", "Назад"),
        ...
        messages.put(LanguageCode.UZ, Map.ofEntries(
                ...
                entry("share_contact_button", "Telefon raqamni ulashish"),
                ...
                entry("field.priority", "Muhimlik"),
                entry("field.location", "Manzil"),
                entry("field.created", "Yaratilgan"),
                entry("field.photos", "Fotolar"),
                entry("field.language", "Til"),
                entry("field.name", "Ism"),
                entry("field.phone", "Telefon"),
                ...
                entry("photo_received", "%d/%d foto qabul qilindi. Yana foto yuboring yoki o'tkazib yuboring."),
                entry("photo_received_max", "%d/%d foto qabul qilindi."),
                entry("photo_duplicate", "Bu foto allaqachon biriktirilgan (%d/%d). Boshqa foto yuboring yoki o'tkazib yuboring."),
                entry("max_photos_reached", "Maksimal %d ta foto qabul qilinadi."),
                entry("photo_invalid", "Noto'g'ri rasm. Iltimos, haqiqiy rasm yuboring."),
                entry("photo_download_failed", "Fotoni qayta ishlab bo'lmadi. Qayta urinib ko'ring."),
                entry("location_prompt", "Geolokatsiyani yuboring, manzil kiriting yoki o'tkazib yuboring."),
                entry("request.location.title", "Geolokatsiyani yuboring, manzil kiriting yoki o'tkazib yuboring."),
                entry("request.location.send_current", "📍 Joriy joylashuvni yuborish"),
                entry("request.location.enter_address", "⌨️ Manzil kiritish"),
                entry("request.location.skip", "⏭ O'tkazib yuborish"),
                entry("request.location.invalid", "Iltimos, geolokatsiya yuboring, manzil kiriting yoki ushbu bosqichni o'tkazib yuboring."),
                entry("request.location.address_prompt", "Iltimos, manzilingizni kiriting:"),
                entry("request.location.received", "Joylashuv qabul qilindi."),
                entry("request.location.not_provided", "Ko'rsatilmadi"),
                entry("request.location.confirmation", "Manzil: %s"),
                entry("confirm_prompt", "Arizani tasdiqlang"),
                entry("request_created", "Ariza yaratildi."),
                ...
                entry("review_confirmation", "Kategoriya: %s\nBaho: %d/5\nIzoh: %s"),
                ...
                entry("telegram.request.priority.LOW", "Past"),
                entry("telegram.request.priority.NORMAL", "Oddiy"),
                entry("telegram.request.priority.HIGH", "Yuqori"),
                entry("telegram.request.priority.URGENT", "Shoshilinch"),
                entry("back", "Orqaga"),
    ...
    public String requestPriority(RepairRequestPriority priority, LanguageCode language) {
        if (priority == null) {
            return get(language, "customer_error");
        }
        return get(language, "telegram.request.priority." + priority.name());
    }
    ...
    public String businessError(LanguageCode language, String code) {
        return get(language, switch (code) {
            ...
            case "VALIDATION_FAILED",
                    ...
                    "REPAIR_REQUEST_LOCATION_INVALID",
                    "REQUEST_LOCATION_LATITUDE_INVALID",
                    "REQUEST_LOCATION_LONGITUDE_INVALID",
                    "REQUEST_LOCATION_COORDINATES_INCOMPLETE",
                    "REQUEST_LOCATION_ADDRESS_TOO_LONG",
                    "REQUEST_LOCATION_SOURCE_INVALID" -> "invalid_request_data";
