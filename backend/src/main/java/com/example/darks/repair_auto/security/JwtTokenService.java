...
public class JwtTokenService {
    ...
    public ValidatedAccessToken validate(String token) {
        try {
            ...
            return new ValidatedAccessToken(
                    numberClaim(claims, "userId"),
                    stringClaim(claims, "sub"),
                    UserRole.valueOf(stringClaim(claims, "role")),
                    OffsetDateTime.ofInstant(Instant.ofEpochSecond(numberClaim(claims, "iat")), ZoneOffset.UTC));
    ...
    public record ValidatedAccessToken(Long userId, String subject, UserRole role, OffsetDateTime issuedAt) {
    }
