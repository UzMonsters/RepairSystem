...
<style scoped>
.contact-page { min-height: 100vh; background: #fbf2e7; color: #321b12; } .contact-header, .contact-content { width: min(calc(100% - 48px), 1440px); max-width: none; margin: 0 auto; box-sizing: border-box; } .contact-header { position: sticky; top: 0; z-index: 10; display: flex; align-items: center; justify-content: space-between; padding: 16px 28px; border-top: 2px solid #321b12; border-bottom: 1px solid #e5cdb9; background: #fbf2e7ee; backdrop-filter: blur(12px); }
