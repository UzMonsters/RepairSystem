...
String mobileText(String language, String key) {
  const strings = <String, Map<String, String>>{
    'ru': {
      ...
      'location': 'Геопозиция',
      'getLocation': 'Определить мою геопозицию',
      'locationReady': 'Геопозиция добавлена',
      'create': 'Создать',
    ...
    'uz': {
      ...
      'getLocation': 'Geolokatsiyamni aniqlash',
      'locationReady': 'Geolokatsiya qo‘shildi',
      'create': 'Yaratish',
      'noRequests': 'Arizalar yo‘q',
      'filters': 'Filtrlar',
      'all': 'Barchasi',
      'new': 'Yangi',
      ...
      'waitingParts': 'Ehtiyot qismlar kutilmoqda',
      'schedule': 'Tashrif jadvali',
      'chat': 'Texnik bilan chat',
      'message': 'Xabar',
